...
async def fetch_hinata(client: httpx.AsyncClient, prompt: str, update: Update = None):
    ...
    if user_id == OWNER_ID or user_name.lower() in ["shawon", "shaun"]:
        ...
        owner_text = "He is your beloved owner and creator. Always show maximum respect, love, and obedience to him."
    else:
    ...
    roast_chance = ""
    # 5% chance to roast depending on user rudeness, represented by spontaneous roast
    ...
    system_text = (
        f"Act exactly like Hinata. {owner_text} "
        f"{mood_instruction} {roast_chance}"
        ...
        f"DO NOT write long paragraphs. Be brief, punchy, and highly conversational. NEVER talk much less, keep the connection alive! "
